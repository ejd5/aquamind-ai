...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Doser selon le volume', detail: 'AquaMind calcule la quantité selon votre volume de bassin.' },
  ...
  },
  {
    ...
    steps: [
      { title: 'Connaître le volume de sa piscine', detail: "Indispensable pour tout dosage. AquaMind le calcule à partir des dimensions." },
      { title: 'Comprendre le pH', detail: 'Le paramètre n°1. Tout part de là.' },
      { title: 'Comprendre le chlore', detail: 'Libre, total, combiné. AquaMind vous guide.' },
      ...
      { title: 'Garder un carnet', detail: 'AquaMind garde l\'historique pour vous.' },
    ],
