/**
 * AQWELIA Care — Shared layout for /care/* marketing pages.
 *
 * Server component. Renders:
 *  - a sticky brand header with logo + Care nav (How it works / Categories /
 *    Catalogue / FAQ / Get notified)
 *  - the page content
...
export default async function CareLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_LINKS = [
    { href: '/care#comment', label: t('navHowItWorks') },
    { href: '/care#categories', label: t('navCategories') },
    { href: '/care/catalogue', label: t('navCatalogue') },
    { href: '/care#faq', label: t('navFaq') },
  ]
