/**
 * ARQWELIA V2 — Landing page (premium "8 of 10" direction).
 *
 * Server component. All visible copy via next-intl `arqwelia.*` (FR / EN only
 * — see ARQWELIA_LOT1.md). Real React components + CSS/SVG scenes.
 *
 * Sections (in order):
 *  1. Hero (premium pool-garden transformation scene)
 *  2. Bande de confiance (trust strip)
...
export default async function ArqweliaLanding() {
  ...
  return (
    <div className="relative">
      {/* ── 1. Hero — premium pool-garden transformation ─────────────────── */}
      <section className="relative overflow-hidden px-4 pb-32 pt-20 sm:px-6 sm:pt-32">
        <div aria-hidden className="pointer-events-none absolute inset-0 opacity-[0.035]" style={{
          backgroundImage: 'radial-gradient(2px 2px at 15% 30%, #5CF2E6, transparent), radial-gradient(2px 2px at 75% 20%, #00D6C5, transparent), radial-gradient(1px 1px at 40% 65%, #5CF2E6, transparent)',
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div className="relative z-10">
              ...
              <h1 className="mt-6 font-aq-display text-[clamp(2rem,5vw,4.5rem)] font-semibold leading-[1.01] text-white [text-shadow:_0_2px_20px_rgb(0_0_0/0.3)]">
                {t('tagline')}
              </h1>
            ...
            {/* Premium pool-garden scene — convincing garden transformation visual */}
            <div className="relative">
              <div className="absolute -inset-4 rounded-[2rem] bg-arq-aqua/5 blur-2xl" aria-hidden />
              <ArqweliaScene variant="dusk-pool" className="aspect-[4/3] w-full rounded-3xl border border-white/[0.08] shadow-arq-deep">
                ...
                <div className="absolute inset-x-0 bottom-0 h-[45%]" aria-hidden style={{
                  background: 'linear-gradient(180deg, rgba(12,37,51,0.3), rgba(6,24,38,0.7) 100%)',
                }}>
                  {/* Terrace deck */}
                  <div className="absolute inset-x-[10%] bottom-[18%] h-[55%] rounded-[2rem] border border-white/[0.04]" style={{
                    background: 'linear-gradient(180deg, rgba(60,50,40,0.4), rgba(30,25,20,0.6))',
                    boxShadow: '0 -2px 20px rgba(0,0,0,0.3)',
                  }} />
                </div>
                {/* Premium pool with realistic water */}
                <div className="absolute left-[15%] right-[15%] top-[30%] bottom-[30%]" aria-hidden
                  style={{
                    background: 'linear-gradient(135deg, rgba(0,214,197,0.35), rgba(92,242,230,0.15) 40%, rgba(0,100,120,0.3) 100%)',
                    borderRadius: '45% 55% 50% 50% / 40% 45% 55% 60%',
                    boxShadow: 'inset 0 -8px 30px rgba(0,214,197,0.15), 0 0 60px rgba(0,214,197,0.08)',
                  }}
                >
                  {/* Water caustic reflections */}
                  <div className="absolute inset-0" style={{
                    background: 'radial-gradient(40% 20% at 30% 40%, rgba(255,255,255,0.12), transparent 70%), radial-gradient(30% 15% at 70% 30%, rgba(255,255,255,0.08), transparent 60%)',
                    borderRadius: 'inherit',
                  }} />
                </div>
                {/* Garden vegetation left */}
                <div className="absolute bottom-[35%] left-[6%] h-[40%] w-[12%]" aria-hidden style={{
                  background: 'radial-gradient(80% 100% at 50% 100%, rgba(40,80,50,0.6), transparent 70%)',
                  filter: 'blur(3px)',
                }} />
                {/* Garden vegetation right */}
                <div className="absolute bottom-[32%] right-[5%] h-[45%] w-[15%]" aria-hidden style={{
                  background: 'radial-gradient(80% 100% at 50% 100%, rgba(50,90,60,0.5), transparent 70%)',
                  filter: 'blur(4px)',
                }} />
                {/* Sun reflection */}
                <div className="absolute right-[12%] top-[8%] h-10 w-10 rounded-full" aria-hidden style={{
                  background: 'radial-gradient(circle, rgba(232,206,159,0.2), transparent 70%)',
                  filter: 'blur(8px)',
                }} />
                {/* AR overlay corners */}
                <div className="pointer-events-none absolute inset-6" aria-hidden>
                  <span className="absolute left-0 top-0 h-8 w-8 border-l-[2.5px] border-t-[2.5px] border-arq-aqua/60 rounded-tl-sm" />
                  <span className="absolute right-0 top-0 h-8 w-8 border-r-[2.5px] border-t-[2.5px] border-arq-aqua/60 rounded-tr-sm" />
                  <span className="absolute left-0 bottom-0 h-8 w-8 border-l-[2.5px] border-b-[2.5px] border-arq-aqua/60 rounded-bl-sm" />
                  <span className="absolute right-0 bottom-0 h-8 w-8 border-r-[2.5px] border-b-[2.5px] border-arq-aqua/60 rounded-br-sm" />
                </div>
                {/* AR scan line */}
                <div className="pointer-events-none absolute left-0 right-0 top-1/2 h-px bg-gradient-to-r from-transparent via-arq-aqua/30 to-transparent" aria-hidden style={{ animation: 'arqScan 3s ease-in-out infinite' }} />
                {/* Deep inset shadow */}
                <div className="absolute inset-0 rounded-3xl" aria-hidden style={{ boxShadow: 'inset 0 0 80px 0 rgba(3,15,26,0.55)' }} />
              </ArqweliaScene>
            </div>
          </div>
        </div>
      ...
      <section className="border-y border-white/[0.06] bg-white/[0.02] py-10">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-4 sm:grid-cols-4 sm:px-6">
          {(['IA', 'AR', 'pros', 'privacy'] as const).map((k) => (
            <div key={k} className="flex items-center justify-center gap-3 text-center text-xs font-semibold uppercase tracking-wider text-white/55">
              <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-arq-aqua" style={{ boxShadow: 'var(--arqwelia-glow-aqua)' }} />
      ...
      {/* ── 3. Parcours en 7 étapes ────────────────────────────────────── */}
      <section id="parcours" className="px-4 py-28 sm:px-6">
        <div className="mx-auto max-w-6xl">
      ...
      <section className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
            ...
            <h2 className="mt-3 font-aq-display text-3xl font-semibold text-white sm:text-4xl">{t('beforeAfterTitle')}</h2>
      ...
      {/* ── 5. IA + AR ─────────────────────────────────────────────────── */}
      <section id="ia-ar" className="px-4 py-24 sm:px-6">
        <div className="mx-auto max-w-5xl">
          <ArqweliaGlassCard className="overflow-hidden" border="strong">
            <div className="grid gap-0 lg:grid-cols-2">
              ...
              <div className="p-8 sm:p-12">
                ...
                <h2 className="mt-4 font-aq-display text-2xl font-semibold text-white sm:text-3xl">{t('iaArTitle')}</h2>
                <p className="mt-4 text-sm leading-relaxed text-white/65">{t('iaArDesc')}</p>
      ...
      <section className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-4xl">
          <ArqweliaGlassCard className="p-8 text-center sm:p-14">
            <ArqweliaLabel>{t('scoreTag')}</ArqweliaLabel>
            <div className="mt-6 flex flex-col items-center gap-8 sm:flex-row sm:items-center sm:justify-center sm:gap-12">
              ...
              <div className="max-w-md text-left">
                ...
                <p className="mt-3 text-sm leading-relaxed text-white/60">{t('scoreDesc')}</p>
              </div>
            </div>
          </ArqweliaGlassCard>
        </div>
      ...
      <section className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-4 font-aq-display text-3xl font-semibold text-white sm:text-4xl">{t('passportTitle')}</h2>
          ...
          <div className="mx-auto mt-12 max-w-sm">
            <ArqweliaGlassCard className="overflow-hidden p-0" border="gold">
              <div className="flex items-center gap-3 border-b border-arq-border-gold px-5 py-4">
      ...
      {/* ── 8. Professionnels vérifiés ─────────────────────────────────── */}
      <section id="pros" className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center">
      ...
      <section className="px-4 py-20 sm:px-6">
        <div className="mx-auto max-w-3xl">
          <ArqweliaGlassCard className="p-10 text-center sm:p-14" border="strong">
            ...
            <p className="mt-6 text-lg font-medium text-white">{t('privacyPromise')}</p>
          </ArqweliaGlassCard>
        </div>
      </section>

      {/* ── 10. Liste d'attente piscinistes ─────────────────────────────── */}
      <section id="partenaire" className="px-4 py-24 sm:px-6">
        <div className="mx-auto max-w-3xl">
          <ArqweliaGlassCard className="p-8 sm:p-10" border="gold">
            <ArqweliaLabel>{t('partnerTitle')}</ArqweliaLabel>
            <h2 className="mt-4 font-aq-display text-2xl font-semibold text-white sm:text-3xl">{t('partnerTitle')}</h2>
            <p className="mt-3 text-sm text-white/65">{t('partnerSubtitle')}</p>
            <div className="mt-8"><ArqweliaPartnerForm /></div>
          </ArqweliaGlassCard>
        </div>
      </section>
            ...
            {[1, 2, 3].map((n) => (
              <ArqweliaGlassCard key={n} className="p-5">
                <details>
                  ...
                  <p className="mt-3 text-sm leading-relaxed text-white/60">{t(`faq.a${n}` as const)}</p>
                </details>
              </ArqweliaGlassCard>
            ))}
          </div>
      ...
      {/* ── 12. CTA final ───────────────────────────────────────────────── */}
      <section className="relative px-4 pb-32 pt-16 text-center sm:px-6">
        ...
        <p className="mx-auto mt-4 max-w-xl text-white/60">{t('finalCtaSubtitle')}</p>
