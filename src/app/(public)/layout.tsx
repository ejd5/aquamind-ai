...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  const isArqwelia = h.get('x-arqwelia-route') === '1'
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background">
      ...
      {/* Page content — ARQWELIA routes already have their own <main> + <footer> from arqwelia/layout.tsx */}
      {isArqwelia ? <div className="flex-1">{children}</div> : (
        <>
