-- AQWELIA — ADMIN CONTROL PLANE V1 (SQLite).
-- Ajoute 4 tables : AdminContentBanner, AdminContentPopup, AdminAuditLog,
-- AdminAgentProposal. Migration additive et sûre : aucune donnée existante
